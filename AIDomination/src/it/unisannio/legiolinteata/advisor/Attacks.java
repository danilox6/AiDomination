...
public class Attacks {
	 ...
	 * @return
	 */
	public static float getVictoryProbability(int attackerArmies, int defenderArmies){
	...
	private static float computeFreeSpaceProb(int attackerArmies, int defenderArmies, int m, int n) {
		//errors:
