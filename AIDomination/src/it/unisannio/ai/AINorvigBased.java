...
import it.unisannio.legiolinteata.search.FortificationAction;
...
public class AINorvigBased extends AISimple{
	...
	public String getPlaceArmies() {
		if(!game.NoEmptyCountries()){
			 ...
			 */
			AdversarialSearch<GameState, FortificationAction> search = AlphaBetaSearch.createFor(tRiskGame);
			FortificationAction action = search.makeDecision(tRiskGame.getInitialState());
